...
def lsf(x, g):
    ...
    stochastic_model.addVariable(Lognormal('x1', x[0], 0.050 * x[0]))
    stochastic_model.addVariable(Lognormal('x2', x[1], 0.025 * x[1]))
    stochastic_model.addVariable(Lognormal('x3', x[2], 0.020 * x[2]))
    stochastic_model.addVariable(Normal('p1', 7e4, 0.080 * 7e4))
    stochastic_model.addVariable(Normal('p2', 8e4, 0.080 * 8e4))
    stochastic_model.addVariable(Normal('p3', 7e10, 0.050 * 7e4))
...
# BOUNDS
bnds = [[0.0010, 0.0050], [0.800, 1.000], [np.pi/6, np.pi/4]]
