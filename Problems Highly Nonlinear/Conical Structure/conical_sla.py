...
x1 = VA('Normal', mean = x0[0], cv = 0.10)
x2 = VA('Normal', mean = x0[1], cv = 0.12)
x3 = VA('Normal', mean = x0[2], cv = 0.08)
x = [x1, x2, x3]

# RANDOM DESIGN PARAMETERS, p = {p1, p2, p3}
p1 = VA('Gumbel_MIN', mean = 7e4, cv = 0.08)
p2 = VA('Gumbel_MIN', mean = 8e4, cv = 0.08)
p3 = VA('Lognormal', mean = 7e10, cv = 0.05)
p = [p1, p2, p3]
